                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <span class="bg-slate-100 dark:bg-gray-800 text-slate-500 dark:text-gray-400 text-[9px] font-black px-3 py-1 rounded-lg uppercase tracking-widest border border-slate-200 dark:border-gray-700">Edición</span>
                            </div>
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Actualizar Datos de Establecimiento</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-[3.5rem] shadow-2xl border border-slate-100 dark:border-gray-800 overflow-hidden">
                        <div class="bg-indigo-600 p-12 text-white flex justify-between items-center">
                            <div class="flex items-center gap-8">
                                ...
                                <div>
                                    <h2 class="text-4xl font-black uppercase tracking-tighter leading-none mb-3">Editar Proveedor</h2>
                                    <p class="text-[11px] font-bold opacity-70 uppercase tracking-[0.3em]">{{ provider.name }}</p>
                                </div>
                            </div>
                            <BuildingStorefrontIcon class="h-12 w-12 opacity-20" />
                        </div>
                        ...
                        <div class="p-12">
                            <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="md:col-span-2">
                                    ...
                                    <TextInput id="name" type="text" class="w-full !rounded-3xl !py-4 !px-6 border-slate-100 dark:border-gray-800 dark:bg-gray-800 dark:text-white focus:ring-indigo-500 shadow-sm" v-model="form.name" required placeholder="Ej. Gourmet Industrial S.A." />
