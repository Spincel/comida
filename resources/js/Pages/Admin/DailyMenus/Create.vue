...
const props = defineProps({
    providers: Array, // Add providers to props
});
...
const submit = () => {
    form.post(route('daily-menus.store'));
};
</script>

<template>
    <Head title="Nuevo Platillo SICOA" />
        ...
        <div class="max-w-3xl mx-auto space-y-8">
            ...
            <div class="bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-[0_10px_35px_-5px_rgba(120,24,42,0.06)] dark:shadow-none border border-slate-200/80 dark:border-gray-800 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-black text-slate-800 dark:text-white uppercase tracking-tight">Agregar Nuevo Platillo</h2>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Catálogo del Día</p>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            required
                            autofocus
                            placeholder="Ej. Huevos con Chilaquiles y Frijoles"
                        />
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            placeholder="Ej. Acompañado de tortillas de maíz y café de olla."
                        />
